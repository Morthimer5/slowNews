...
public class InitNews {
    private static ArrayList<News> breakinNews;
    static public HashMap<Integer, News> allnews;
    private int currentID = 0;
    
    public ArrayList getAllNews(){
        ArrayList<News> newsList = new ArrayList<>();
        newsList.add(new News("Scientists just found...", ("Not to blow your mind but the universe " +
                ...
                "Scients.jpg", Topic.SCIENSE, currentID++));
        newsList.add(new News("WattUp Can Wirelessly Charge Devices From 15 Feet Away",
                ...
                "as early as 2016.", "Money.jpg", Topic.MONEY, currentID++));
        newsList.add(new News("SlowNews Are Here", "We're open!", "slowpoke.jpg", Topic.OTHER, currentID++));
        breakinNews = newsList;

        return newsList;
    }
    private ArrayList<News> generate(){
        breakinNews.clear();
        for (int i = 0; i < 5; i++) {
            breakinNews.add(createNews());
        }
        return breakinNews;
    }
